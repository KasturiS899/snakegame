...
public class Jpanel extends JPanel implements ActionListener {
    ...
    public void draw(Graphics graphics) {
        if (flag) {
            ...
            graphics.drawString("Score : " + score, (width - fme.stringWidth("Score : " + score)) / 2,
            ...
            graphics.drawString("Game Over ! " + score, (width - fme.stringWidth("Game Over ! " + score)) / 2,
                    height / 2);
            ...
            graphics.setFont(new Font("Comic Sans MS", Font.BOLD, 40));
            fme = getFontMetrics(graphics.getFont());
            graphics.drawString("Press R to Replay " + score,
                    (width - fme.stringWidth("Press R to Replay " + score)) / 2, height / 2 + 150);
        }
    }
